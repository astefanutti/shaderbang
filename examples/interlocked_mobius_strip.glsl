#!/usr/bin/env -S ./shadertoy.py -t iChannel0 presets/tex_rusty_metal.jpg -t iChannel1 presets/tex_wood.jpg -c iChannel2 presets/cube_st_peter_basilica_blurred.png
