...
def run():
    ...
    try:
        cloth_mat = pt.add_material(base_color=(0.2, 0.45, 0.85),
                                    ...
                                    roughness=0.6)
        sphere_mat = pt.add_material(base_color=(0.8, 0.25, 0.2), roughness=0.3)
        ground_mat = pt.add_material(base_color=(0.55, 0.55, 0.6), roughness=0.9)
        ...
        pt.add_sphere(center=(0.0, 1.5, 0.0), radius=0.5, material_id=sphere_mat)
        pt.add_plane(normal=(0.0, 1.0, 0.0), offset=0.0, material_id=ground_mat)
